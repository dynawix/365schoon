	...
	function init_template(){        
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        setTimeout(function(){
            ...
            $('.single-slider-boxed').owlCarousel({loop:true, margin:20, stagePadding:50, nav:false, lazyLoad:true, items:1, autoplay: true, autoplayTimeout:4000});		
            ...
            $('.double-slider').owlCarousel({loop: true, stagePadding:15, margin: 23, nav: false, items: 2, autoplay:true, autoPlayTimeout:4000, dots: false});		
